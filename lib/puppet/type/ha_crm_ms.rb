Puppet::Type.newtype(:ha_crm_ms) do
  @doc = "Manage Pacemaker multi-state clones"
  ...
  newproperty(:master_max) do
    desc "How many copies of the resource can be promoted to master status.  If
  ...
  newproperty(:master_node_max) do
    desc "How many copies of the resource can be promoted to master status on a
          single node.  If absent, defaults to 1."
