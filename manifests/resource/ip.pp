define ha::resource::ip($ip, $nic, $resource_stickiness=absent, $unique_clone_address=false, $cidr_netmask=nil, $network=nil, $monitor_interval = "60", $monitor_timeout = "20", $ensure = present) {
  ha_crm_primitive { 
    "${name}":
